...
public class AgentTest {
    ...
    public void shouldDeserializeFromJSON() throws Exception {
        ...
        assertThat(agent.agentState(), Matchers.is(Agent.AgentState.Building));
        assertThat(agent.buildState(), Matchers.is(Agent.BuildState.Cancelled));
        assertThat(agent.configState(), Matchers.is(Agent.ConfigState.Disabled));
    }
