...
public class GetProfileViewExecutorTest {
    ...
    public void allFieldsShouldBePresentInView() throws Exception {
        ...
        for (Metadata field : GetProfileMetadataExecutor.FIELDS) {
            ...
            assertThat(spanToShowError.attr("ng-show"), Matchers.is("GOINPUTNAME[" + field.getKey() + "].$error.server"));
            assertThat(spanToShowError.text(), Matchers.is("{{GOINPUTNAME[" + field.getKey() + "].$error.server}}"));
        }
