...
public class ClusterStatusReportExecutor {
    ...
    ClusterStatusReportExecutor(ClusterStatusReportRequest clusterStatusReportRequest, DockerServices agentInstances, DockerClientFactory dockerClientFactory, ViewBuilder viewBuilder) {
